...
RealMatrixTest::RealMatrixTest() {
    ...
    TEST_ADD(RealMatrixTest::test_getValue);
    TEST_ADD(RealMatrixTest::test_setValue);
    ...
    TEST_ADD(RealMatrixTest::test_plus_equal);
    TEST_ADD(RealMatrixTest::test_minus_equal);
    TEST_ADD(RealMatrixTest::test_multiply_equal);
    TEST_ADD(RealMatrixTest::test_multiply_matrix);
    TEST_ADD(RealMatrixTest::test_transpose);
    TEST_ADD(RealMatrixTest::test_determinant);
    TEST_ADD(RealMatrixTest::test_substraction);
    TEST_ADD(RealMatrixTest::test_product);
}

void RealMatrixTest::test_sizeConstructor() {
    // Test des tailles illegales
...
invalid_argument exception");
    ...
    // Test d'un constructeur correcte
    RealMatrix m4(10, 6);
...
void RealMatrixTest::test_getValue() {
...
void RealMatrixTest::test_setValue() {
    RealMatrix m(10, 10, 0);
    m.set(2, 3, 40);
    m.set(5, 3, -3);
...
void RealMatrixTest::test_plus_equal() {
    RealMatrix a(3, 3);
    double array_a[9] = {
        1, 2, 3,
        4, 5, 6,
...
void RealMatrixTest::test_minus_equal() {
    RealMatrix a(3, 3);
    double array_a[9] = {
        1, 2, 3,
        4, 5, 6,
...
void RealMatrixTest::test_multiply_equal() {
    RealMatrix a(3, 3);
    double array_a[9] = {
        1, 2, 3,
        4, 5, 6,
...
void RealMatrixTest::test_multiply_matrix() {
    RealMatrix a(2, 3);
    double array_a[9] = {
        1, 2, 3,
        4, 5, 6
...
void RealMatrixTest::test_product() {
    RealMatrix a(2, 3);
    double array_a[9] = {
        1, 2, 3,
        4, 5, 6
